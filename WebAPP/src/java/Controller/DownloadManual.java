...
import Controller.DownloadManual;
import java.io.File;
 ...
 */
@WebServlet(name = "DownloadManual", urlPatterns = {"/DownloadManual"})
public class DownloadManual extends HttpServlet {

    public static int BUFFER_SIZE = 1024 * 100;
    public static final String UPLOAD_DIR = "resources/manuales";
...
//            response.getWriter().println("<h3>File " + fileName + " Is Not Present .....!</h3>");
            ...
            response.sendRedirect("MenuManuales.jsp");
