 ...
 * @author jean
 */
@WebServlet(name = "subirExamenesG", urlPatterns = {"/subirExamenesG"})
@MultipartConfig(fileSizeThreshold = 1024 * 1024 * 10, // 10 MB
        maxFileSize = 1024 * 1024 * 1000, // 1 GB
        maxRequestSize = 1024 * 1024 * 1000)   	// 1 GB
public class subirExamenesG extends HttpServlet {
...
//            String lastName = request.getParameter("lastname");//Textbox value of name lastname.
            ...
            try {
                ...
                String sql = "UPDATE public.ginecologia_seguimiento SET archivo=?, patch=? WHERE gineseguimiento_id="+codigo+"";
