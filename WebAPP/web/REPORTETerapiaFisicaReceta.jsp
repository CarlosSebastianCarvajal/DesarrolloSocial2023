<%-- 
    Document   : REPORTETerapiaFisicaReceta
    Created on : 30-dic-2022, 2:33:48
...
con la siguiente linea de codigo*/
    ...
    File reportFile = new File(application.getRealPath("/Reportes/Receta_tf_mejorado.jasper"));
...
y seguiremos el formato del método runReportToPdf*/
 /*Con Map y el HaspMap nos servira para crear los paramentros*/
    ...
    String fi_ = request.getParameter("fechaConsulta");
