...
<html>
    ...
    <body>
       ...
       -->
        ...
        <form name="form1" method="post" action="REPORTEGinEvolucion.jsp" target="_blank" >
            <section class="sec-main">
                <div class="div-cont-main"> 
                    <div class="div-cont-ced">
                        <table style='width: 100%; text-align: center; margin-left: 20px; margin-top: 30px' >
                    ...
                    <div class="div-cont-ced">
                        <table style='width: 100%; text-align: center; margin-left: 20px; margin-top: 30px' >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><div class="div-cont-ced" style='margin-top: 10px !important;'><input type="text" id="Cedula" class="inp-ced" placeholder="Cédula del paciente" name="Cedula" required=""/></div></td>
        ...
        <form name="form1" method="post" action="ReporteHC_PERINATAL.jsp" target="_blank" >
            <section class="sec-main">
                <div class="div-cont-main"> 
                    <div class="div-cont-ced">
                        <table style='width: 100%; text-align: center; margin-left: 20px; margin-top: 30px' >
                            <thead>
                                <h1 class="textgrueso"  style='text-align: center; '>HISTORIA CLINICA PERINATAL</h1>
                            </thead>
                            <tbody>
                                <tr>
                                    <th><div></div>Ingrese Cédula del paciente</th>
        ...
        <form name="form1" method="post" action="REPORTE_CLINICO_OBS.jsp" target="_blank" >
            <section class="sec-main">
                <div class="div-cont-main"> 
                    <div class="div-cont-ced">
                        <table style='width: 100%; text-align: center; margin-left: 20px; margin-top: 30px' >
