                ...
                <tbody id="tbodys">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="SubirExamenesG.jsp?codigo=<%= rs.getInt("codigo")%>" class="btn btn-primary">Seleccionar Paciente</a>
                        </td>
                    </tr>
                    <%}%>
            </table>
