<%-- 
    Document   : REPORTESeguimiento
    Created on : 12-ene-2023, 0:00:21
    Author     : Miguel
--%>
...
con la siguiente linea de codigo*/
    ...
    File reportFile = new File(application.getRealPath("/Reportes/ReporteSeguimiento.jasper"));
...
varchar(5), lo almacenamos en una String*/
    ...
    String numero = request.getParameter("numeroSesion");
...
reporte solo nos pide un parametro*/
    parameters.put("cedulaPaciente", cedula);
    parameters.put("sesionPaciente", Integer.parseInt(numero));
