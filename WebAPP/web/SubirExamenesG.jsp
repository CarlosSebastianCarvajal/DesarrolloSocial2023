<%-- 
    Document   : SubirExamenesG
    Created on : 03-jul-2023, 11:23:49
    Author     : Miguel
--%>
            ...
            <form id="form1" action="subirExamenesG" method="POST" enctype="multipart/form-data" >
                ...
                <div class="div-cont-main">
                    <table style='width: 100%; text-align: center; margin-left: 20px; margin-top: 30px'>
                        ...
                        <tbody>
                            <tr>  
                                <td> <div class="div-cont-ced" style='margin-top: 10px !important;'><input value="<%= rs.getString("notas")%>" type="text" id="txt-cedi" readonly="" class="inp-ced" name="txtDNI" /></div> </td>
                            </tr>
                        </tbody>
                        <thead>
                            <tr>
