...
<html>
    ...
    <body>
        ...
        <form class="form1" action="ActualizarSeguimiento" method="GET" style="margin-top:-30px">
                ...
                <hr />
                    <table style='width: 100%; text-align: center; margin-left: 20px; margin-top: 30px'>
                        <thead>
                            <tr>
                                <th>Sesión No.</th>
                                <td><div class="div-cont-name"><input type="text" id="txt-sesion" class="inp-name" placeholder="No" name="sesionnumero" required=""  onkeypress="return soloLetras(event)" onkeyup="mayus(this);"/></div></td>
                                <td><input  type="button" id="btn-actionbuSesion" class="inp-search1" value="Buscar"/></td>
                            </tr>
                        </thead>
                        <thead>
                            <tr>
                                <th>Fecha:</th>
                                <td><div class="div-cont-lname"><input type="text" id="txt-fechaAc" class="inp-lname" placeholder="Fecha"required=""  name="FechaActual"/></div></td>
                            </tr>
                        </thead>
                    </table>
                        <table style='width: 100%; text-align: center; margin-left: 20px; margin-top: 30px'>
    ...
    <script src="js/ConsultarSeguimiento.js" type="text/javascript"></script>
</html>
