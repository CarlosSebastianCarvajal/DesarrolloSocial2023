            ...
            <section class="sec-main">
                <div id="divv" class="div-cont-main" style="margin-top: 9900px">
                    ...
                    <table align="center" style='width: 98%; margin-left: 10px; margin-top: 30px'>
                       <thead>
                        ...
                        <tbody align="center">
                            <tr> 
                                ...
                                <td><div class="div-cont-name"><input style= 'text-align: center' type="text" id="txt-FrecuenciaC" class="inp-name" placeholder="Frecuencia Cardíaca" name="frecuencia_cardiaca" required="" maxlength="3" onkeypress="return validaNumericos(event)" /></div></td>
                        ...
                        <thead>
                            <tr>                                
                                ...
                                <td><div class="div-cont-name"><input style="width: 1000px;" style='text-align: left' type="text" id="txt-personales" class="inp-name" placeholder="Personales" name="ap_personales" required="" maxlength="1000" onkeypress="return soloLetras(event)" onkeyup="mayus(this);"/></div></td>
                            </tr>
                        </thead>
                        <thead >
                            <tr>                                
                                <th style="width: 300px;">Familiares:</th>
                                <td><div class="div-cont-name"><input style="width: 1000px;" style= 'text-align: left' type="text" id="txt-familiares" class="inp-name" placeholder="Familiares" name="ap_familiares" required="" maxlength="1000" onkeypress="return soloLetras(event)" onkeyup="mayus(this);"/></div></td>
                            </tr>
                        </thead>
                        <thead >
                            <tr>                                
                                <th style="width: 300px;">Quirúrgicos:</th>
                                <td><div class="div-cont-name"><input style="width: 1000px;" style= 'text-align: left' type="text" id="txt-quirurgicos" class="inp-name" placeholder="Quirúrgicos" name="ap_quirurgicos" required="" maxlength="1000" onkeypress="return soloLetras(event)" onkeyup="mayus(this);"/></div></td>
                            </tr>
                        </thead>
                        <thead >
                            <tr>                                
                                <th style="width: 300px;">Alérgicos:</th>
                                <td><div class="div-cont-name"><input style="width: 1000px;" style= 'text-align: left' type="text" id="txt-alergicos" class="inp-name" placeholder="Alérgicos" name="ap_alergicos" required="" maxlength="1000" onkeypress="return soloLetras(event)" onkeyup="mayus(this);"/></div></td>
                            </tr>
                        </thead>
                        <thead >
                            <tr>                                
                                <th style="width: 300px;">Hábitos Nocivos:</th>
                                <td><div class="div-cont-name"><input style="width: 1000px;" style= 'text-align: left' type="text" id="txt-habitos" class="inp-name" placeholder="Hábitos Nocivos" name="ap_habitos" required="" maxlength="1000" onkeypress="return soloLetras(event)" onkeyup="mayus(this);"/></div></td>
                            </tr>
                        </thead>
                        </table>
                        <table align="center" style='width: 98%; margin-left: 10px; margin-top: 30px'>
                       ...
                       <thead >
                        ...
                        <thead >
                            <tr>                                
                                ...
                                <td><div class="div-cont-name"><input input style="width: 1000px;" style= 'text-align: center' type="text" maxlength="1000" id="txt-Complicaciones" class="inp-name" placeholder="Complicaciones" name="ago_complicaciones" required=""  onkeypress="return soloLetras(event)" onkeyup="mayus(this);"/></div></td>
                            </tr>
                        </thead>
                        </table>
                        <table align="center" style='width: 98%; margin-left: 10px; margin-top: 10px'>
                        <thead>
                         ...
                         <tbody>
                            <tr style='height: 175px'>
                                <td colspan="4" align="left"><div class="div-cont-ln" style="height: 175px;"><textarea type="text" maxlength="1000" id="txt-MotivoCon" class="inp-lname"  placeholder="Motivo de la Consulta" name="motivo_consulta" onkeyup="mayus(this);"style='height: 120px;'/></textarea></td> 
                            </tr>
                        </tbody>
                        <thead>
                            <tr>
                       ...
                       <tbody>
                            <tr style='height: 175px'>
                                <td colspan="4" align="left"><div class="div-cont-ln" style="height: 175px;"><textarea type="text" maxlength="1000" id="txt-EnfermedadAc" class="inp-lname" placeholder="Enfermedad Actual" name="enfermedad_acual" onkeyup="mayus(this);"style='height: 120px;'/></textarea></td> 
                            </tr>
                        </tbody>
                        <thead>
                            <tr>
                    ...
                    <!--   SECCION DE HISTORIA CLINICA PERINATAL -->
                        ...
                        <table  style='width: 95%; margin-left: 10px; '>
                            ...
                            <tbody  align="center">
                                ...
                                <td style= 'width: 25%;'>
                                    <div id="per_alfa_beta" style="border-style: solid; border-color: #d5ddda; border-radius: 10px; background: #d5ddda; width: 80%; height: 40px; display: flex; justify-content: center; align-items: center;" >
                                        <span style="margin-top: 2px">SI: </span>
                                        <input style="margin-top: 2px" type="radio" id="rb-per-alfa-beta-si" name="per_alfa_beta" value="Si" />
                                        <span style="margin-top: 2px">&nbsp &nbsp &nbsp NO: </span>
                                        <input style="margin-top: 2px" type="radio" id="rb-per-alfa-beta-no" name="per_alfa_beta" value="No" />
                                    </div>
                                </td>
                                ...
                                <td style= 'width: 25%;'><input style= 'text-align: center; width: 80%;' class="inp-lname" type="text" id="txt-anios-nivel1"  placeholder="Años" name="fechaNac" value="" readonly="readonly" /></td>
                            </tbody>
                            <thead></thead><thead></thead><thead></thead><thead></thead><thead></thead><thead></thead><thead></thead><thead></thead><thead></thead><thead></thead><thead></thead><thead></thead><thead></thead><thead></thead><thead></thead><thead></thead>
                            <thead >
                                <th>Estado Civil</th>
                            ...
                            <tbody  align="center">
                                ...
                                <td>
                                    <div id="per_vive_sola" style="border-style: solid; border-color: #d5ddda; border-radius: 10px; background: #d5ddda; width: 80%; height: 40px; display: flex; justify-content: center; align-items: center;" id="">
                                        <span style="margin-top: 2px">SI: </span>
                        ...
                        <table style='width: 95%; margin-left: 10px; '>
                            ...
                            <tbody  align="center">
                                <td  style= 'width: 11%;'>
                                    <div id="ap_tbc" style="border-style: solid; border-color: #d5ddda; border-radius: 10px; background: #d5ddda;width: 90%; height: 40px; display: flex; justify-content: center; align-items: center;">
                                        <span style="margin-top: 2px">SI: </span>
