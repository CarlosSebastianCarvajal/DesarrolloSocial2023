<%-- 
    Document   : REPORTE_Solicitud_Ginecologia
    Created on : 22-jun-2023, 21:15:57
    Author     : Miguel
--%>
...
con la siguiente linea de codigo*/
    ...
    File reportFile = new File(application.getRealPath("/Reportes/ReporteHistopatologico.jasper"));
...
reporte solo nos pide un parametro*/
    System.out.println(cedula+" "+ff);
    parameters.put("cedula", cedula);
    parameters.put("fecha", ff);
